    ...
    return (
        <Modal open={open} onClose={handleClose} closeAfterTransition>
            ...
            >
                ...
                <Typography variant="h6" gutterBottom  sx={{textDecoration: 'underline', fontSize: '1.5rem' }}>
                    Bitte lesen die folgenden Risikohinweise genau und überfliegen Sie diese nicht nur.
                </Typography>
                <Typography variant="body1" gutterBottom sx={{ fontWeight: 'bold', color: 'black', fontSize: '1.4rem' }}>
