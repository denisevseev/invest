...
//                 setPassportFiles(prevFiles => [...prevFiles, ...acceptedFiles.map(file => Object.assign(file, {
...
//                 setAddressFiles(prevFiles => [...prevFiles, ...acceptedFiles.map(file => Object.assign(file, {
//                     preview: URL.createObjectURL(file)
//                 }))]);
//             } else {
...
//         if (response.ok) {
//             fetchFiles();
//             alert(`${type.charAt(0).toUpperCase() + type.slice(1)} files uploaded successfully!`);
//         } else {
...
//                 color="primary"
//                 sx={{ mt: 2 }}
//                 onClick={() => handleUpload(passportFiles, 'passport', setPassportFiles)}
...
//                 color="primary"
//                 sx={{ mt: 2 }}
//                 onClick={() => handleUpload(addressFiles, 'address', setAddressFiles)}
//                 disabled={addressFiles.length === 0}
//             >
//                 Save Address Files
//             </Button>
